...
// <div
//   className='flex flex-col w-72 h-96 rounded-5xl border-2 border-solid border-card-color bg-zinc-950 cursor-pointer hover:shadow-[0_0_30px_1px_rgba(0,255,117,0.3)]'
//   onClick={openProductDetail}
// >
//   <figure className='flex-grow relative w-full h-[37%]'>
//     <img
//       className='w-full h-full p-0.5 rounded-t-5xl object-cover text-white'
//       src={pictureUrl}
//       alt={description}
//       onError={onImgLoadError}
//     />
